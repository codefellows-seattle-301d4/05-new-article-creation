...
articleView.create = function() {
  ...
  var formArticle = new Article({
    ...
    publishedOn: $('#article-published:checked').length ? new Date() : null // ternary operator? basically an inline if else. if true, do first (which is New Date()), otherwise do second, which is null.
  });
