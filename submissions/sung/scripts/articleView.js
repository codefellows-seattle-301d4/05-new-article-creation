...
articleView.initNewArticlePage = function() {
  ...
  $('#new-form').on('change', 'input', 'textarea', articleView.create); //a non anonymous function does not need to be called as the event handler will call it for us
};
...
articleView.create = function() {
  ...
  }); //does the checkbox have a length (checked === 1) ?, if it does then run the Date operator, otherwise keep it empty
