...
articleView.create = function() {
  ...
  var formArticle = new Article({
    ...
    publishedOn: $('#article-published:checked').length ? new Date() : null //ternary operator inline if/else statement
  });
  ...
  //Uses highlight.js
  $('pre code').each(function(index, block){ //<pre>formats the text like code</pre><code>formats a block of text like code.</code>
