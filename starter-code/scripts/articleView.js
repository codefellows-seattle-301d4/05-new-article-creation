...
articleView.create = function() { //constructor function
  // TODO: Set up a var to hold the new article we are creating.
  var formArticle = new Article({ //is creating new objects
    title: $('#article-title').val(),
    body: $('#article-body').val(),
    author: $('#article-author').val(),
    authorUrl: $('#article-author-url').val(),
    category: $('#article-category').val(),
    publishedOn: $('#article-published:checked').length ? new Date() : null //turnary operator-- if else basically with new Date() as if and : as || and null as else
  });
